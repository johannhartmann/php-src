...
ZEND_MIR_VALUE_VIEW_ACCESSORS(
	zend_mir_value_view_suspend_live_value, value_suspend_live_values,
...
void zend_mir_module_init_value_view(zend_mir_module *module)
{
	...
	module->value_view.suspend_live_value_count =
		zend_mir_value_view_suspend_live_value_count;
	module->value_view.suspend_live_value_at =
		zend_mir_value_view_suspend_live_value_at;
}
