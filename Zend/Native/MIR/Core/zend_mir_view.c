...
ZEND_MIR_VALUE_VIEW_ACCESSORS(
	zend_mir_value_view_verifier_receipt, value_verifier_receipts,
...
void zend_mir_module_init_value_view(zend_mir_module *module)
{
	...
	module->value_view.verifier_receipt_count =
		zend_mir_value_view_verifier_receipt_count;
	module->value_view.verifier_receipt_at =
		zend_mir_value_view_verifier_receipt_at;
}
