...
static const zend_native_runtime_helper zend_native_runtime_helpers[] = {
	...
	{ZEND_NATIVE_HELPER_VALUE_INIT_ARRAY, ZEND_NATIVE_RUNTIME_EFFECT_ALL,
		(const void *) zend_native_value_init_array},
	{ZEND_NATIVE_HELPER_VALUE_ADD_ARRAY_ELEMENT, ZEND_NATIVE_RUNTIME_EFFECT_ALL,
		(const void *) zend_native_value_add_array_element},
	{ZEND_NATIVE_HELPER_VALUE_ADD_ARRAY_UNPACK, ZEND_NATIVE_RUNTIME_EFFECT_ALL,
		(const void *) zend_native_value_add_array_unpack},
	{ZEND_NATIVE_HELPER_VALUE_FETCH_DIM_R, ZEND_NATIVE_RUNTIME_EFFECT_ALL,
		(const void *) zend_native_value_fetch_dim_r},
	{ZEND_NATIVE_HELPER_VALUE_FETCH_DIM_W, ZEND_NATIVE_RUNTIME_EFFECT_ALL,
		(const void *) zend_native_value_fetch_dim_w},
	{ZEND_NATIVE_HELPER_VALUE_FETCH_DIM_RW, ZEND_NATIVE_RUNTIME_EFFECT_ALL,
		(const void *) zend_native_value_fetch_dim_rw},
	{ZEND_NATIVE_HELPER_VALUE_FETCH_DIM_IS, ZEND_NATIVE_RUNTIME_EFFECT_ALL,
		(const void *) zend_native_value_fetch_dim_is},
	{ZEND_NATIVE_HELPER_VALUE_FETCH_DIM_FUNC_ARG, ZEND_NATIVE_RUNTIME_EFFECT_ALL,
		(const void *) zend_native_value_fetch_dim_func_arg},
	{ZEND_NATIVE_HELPER_VALUE_FETCH_DIM_UNSET, ZEND_NATIVE_RUNTIME_EFFECT_ALL,
		(const void *) zend_native_value_fetch_dim_unset},
	{ZEND_NATIVE_HELPER_VALUE_ASSIGN_DIM, ZEND_NATIVE_RUNTIME_EFFECT_ALL,
		(const void *) zend_native_value_assign_dim},
	{ZEND_NATIVE_HELPER_VALUE_ASSIGN_DIM_OP, ZEND_NATIVE_RUNTIME_EFFECT_ALL,
		(const void *) zend_native_value_assign_dim_op},
	{ZEND_NATIVE_HELPER_VALUE_UNSET_DIM, ZEND_NATIVE_RUNTIME_EFFECT_ALL,
