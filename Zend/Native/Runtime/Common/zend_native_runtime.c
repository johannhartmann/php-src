...
static const zend_native_runtime_helper zend_native_runtime_helpers[] = {
	...
	{ZEND_NATIVE_HELPER_VALUE_FUNC_NUM_ARGS,
		ZEND_NATIVE_RUNTIME_EFFECT_FRAME_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_OBSERVE,
		(const void *) zend_native_value_func_num_args},
	...
	{ZEND_NATIVE_HELPER_VALUE_COUNT,
		ZEND_NATIVE_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_HEAP_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_DESTRUCT
			| ZEND_NATIVE_EFFECT_MAY_REENTER
			| ZEND_NATIVE_EFFECT_MAY_FAIL,
		(const void *) zend_native_value_count},
	{ZEND_NATIVE_HELPER_VALUE_GET_TYPE,
		ZEND_NATIVE_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_DESTRUCT
			| ZEND_NATIVE_RUNTIME_EFFECT_ALLOCATE
			| ZEND_NATIVE_EFFECT_MAY_FAIL,
		(const void *) zend_native_value_get_type},
	{ZEND_NATIVE_HELPER_VALUE_ARRAY_KEY_EXISTS,
		ZEND_NATIVE_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_ARRAY_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_DESTRUCT
			| ZEND_NATIVE_EFFECT_MAY_REENTER
			| ZEND_NATIVE_EFFECT_MAY_FAIL,
		(const void *) zend_native_value_array_key_exists},
	{ZEND_NATIVE_HELPER_VALUE_IN_ARRAY,
		ZEND_NATIVE_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_ARRAY_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_DESTRUCT
			| ZEND_NATIVE_EFFECT_MAY_REENTER
			| ZEND_NATIVE_EFFECT_MAY_FAIL,
		(const void *) zend_native_value_in_array},
	{ZEND_NATIVE_HELPER_VALUE_ISSET_THIS,
		ZEND_NATIVE_RUNTIME_EFFECT_FRAME_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_FRAME_WRITE,
		(const void *) zend_native_value_isset_this},
	{ZEND_NATIVE_HELPER_VALUE_GET_CALLED_CLASS,
		ZEND_NATIVE_RUNTIME_EFFECT_FRAME_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_REFCOUNT
			| ZEND_NATIVE_EFFECT_MAY_FAIL,
		(const void *) zend_native_value_get_called_class},
	{ZEND_NATIVE_HELPER_VALUE_BEGIN_SILENCE,
		ZEND_NATIVE_RUNTIME_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_HEAP_WRITE,
		(const void *) zend_native_value_begin_silence},
	{ZEND_NATIVE_HELPER_VALUE_END_SILENCE,
		ZEND_NATIVE_RUNTIME_EFFECT_FRAME_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_HEAP_WRITE,
		(const void *) zend_native_value_end_silence},
	{ZEND_NATIVE_HELPER_VALUE_MATCH_ERROR,
		ZEND_NATIVE_RUNTIME_EFFECT_THROW
			| ZEND_NATIVE_RUNTIME_EFFECT_ALLOCATE
			| ZEND_NATIVE_RUNTIME_EFFECT_DESTRUCT,
		(const void *) zend_native_value_match_error},
	{ZEND_NATIVE_HELPER_VALUE_VERIFY_NEVER_TYPE,
		ZEND_NATIVE_RUNTIME_EFFECT_THROW
			| ZEND_NATIVE_RUNTIME_EFFECT_ALLOCATE,
		(const void *) zend_native_value_verify_never_type},
	{ZEND_NATIVE_HELPER_VALUE_DEFINED,
		ZEND_NATIVE_RUNTIME_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_HEAP_READ,
		(const void *) zend_native_value_defined},
	{ZEND_NATIVE_HELPER_VALUE_TICKS,
		ZEND_NATIVE_RUNTIME_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_HEAP_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_USERLAND
			| ZEND_NATIVE_RUNTIME_EFFECT_REENTER
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW,
		(const void *) zend_native_value_ticks},
	{ZEND_NATIVE_HELPER_VALUE_TYPE_ASSERT,
		ZEND_NATIVE_RUNTIME_EFFECT_FRAME_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_HEAP_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_ALLOCATE
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW,
		(const void *) zend_native_value_type_assert},
	{ZEND_NATIVE_HELPER_VALUE_EXT_STMT,
		ZEND_NATIVE_RUNTIME_EFFECT_FRAME_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_USERLAND
			| ZEND_NATIVE_RUNTIME_EFFECT_REENTER
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW,
		(const void *) zend_native_value_ext_stmt},
	{ZEND_NATIVE_HELPER_VALUE_EXT_FCALL_BEGIN,
		ZEND_NATIVE_RUNTIME_EFFECT_FRAME_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_USERLAND
			| ZEND_NATIVE_RUNTIME_EFFECT_REENTER
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW,
		(const void *) zend_native_value_ext_fcall_begin},
	{ZEND_NATIVE_HELPER_VALUE_EXT_FCALL_END,
		ZEND_NATIVE_RUNTIME_EFFECT_FRAME_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_USERLAND
			| ZEND_NATIVE_RUNTIME_EFFECT_REENTER
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW,
		(const void *) zend_native_value_ext_fcall_end},
	{ZEND_NATIVE_HELPER_VALUE_EXT_NOP,
		0,
		(const void *) zend_native_value_ext_nop},
	...
	{ZEND_NATIVE_HELPER_USER_CALL_RESOLVE,
		ZEND_NATIVE_EFFECT_CALL,
		(const void *) zend_native_call_resolve_user},
	{ZEND_NATIVE_HELPER_USER_CALL_RELEASE_RESOLUTION,
		ZEND_NATIVE_EFFECT_CALL,
		(const void *) zend_native_call_release_user_resolution},
	{ZEND_NATIVE_HELPER_FINALLY_RETURN_EXPLICIT,
		ZEND_NATIVE_EFFECT_FRAME_WRITE | ZEND_NATIVE_RUNTIME_EFFECT_THROW,
		(const void *) zend_native_finally_return_explicit},
	{ZEND_NATIVE_HELPER_CATCH_EXPLICIT,
		ZEND_NATIVE_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_HEAP_READ
			| ZEND_NATIVE_RUNTIME_EFFECT_DESTRUCT
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW,
		(const void *) zend_native_catch_explicit},
	{ZEND_NATIVE_HELPER_RECEIVE_EXPLICIT,
		ZEND_NATIVE_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_ALLOCATE
			| ZEND_NATIVE_RUNTIME_EFFECT_DESTRUCT
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW,
		(const void *) zend_native_receive_explicit},
	{ZEND_NATIVE_HELPER_CALL_FRAGMENT,
		ZEND_NATIVE_EFFECT_CALL,
		(const void *) zend_native_call_fragment},
	...
	{ZEND_NATIVE_HELPER_USER_CALL_NORMALIZE_RESOLUTION,
		ZEND_NATIVE_EFFECT_CALL,
		(const void *) zend_native_call_normalize_user_resolution},
	{ZEND_NATIVE_HELPER_RECEIVE_EXPLICIT_PENDING,
		ZEND_NATIVE_EFFECT_CALL,
		(const void *) zend_native_receive_explicit_pending},
	{ZEND_NATIVE_HELPER_CALL_CONVERT_EXPLICIT,
		ZEND_NATIVE_EFFECT_CALL,
		(const void *) zend_native_call_convert_descriptor_explicit},
	{ZEND_NATIVE_HELPER_CALL_RESERVE_DYNAMIC_FRAME,
		ZEND_NATIVE_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_ALLOCATE
			| ZEND_NATIVE_RUNTIME_EFFECT_BAILOUT,
		(const void *) zend_native_call_reserve_dynamic_frame},
	{ZEND_NATIVE_HELPER_USER_CALL_EXPAND_ARGUMENTS,
		ZEND_NATIVE_EFFECT_FRAME_READ | ZEND_NATIVE_EFFECT_FRAME_WRITE
			...
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW
			| ZEND_NATIVE_RUNTIME_EFFECT_BAILOUT,
		(const void *) zend_native_call_expand_user_arguments},
	{ZEND_NATIVE_HELPER_FRAME_PREPARE,
		ZEND_NATIVE_EFFECT_FRAME_READ | ZEND_NATIVE_EFFECT_FRAME_WRITE
			...
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW
			| ZEND_NATIVE_RUNTIME_EFFECT_BAILOUT,
		(const void *) zend_native_call_prepare_dynamic_frame},
	{ZEND_NATIVE_HELPER_FRAME_OBSERVER_BEGIN,
		ZEND_NATIVE_EFFECT_FRAME_READ | ZEND_NATIVE_EFFECT_FRAME_WRITE
			...
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW
			| ZEND_NATIVE_RUNTIME_EFFECT_BAILOUT,
		(const void *) zend_native_frame_observer_begin},
	{ZEND_NATIVE_HELPER_FRAME_OBSERVER_END,
		ZEND_NATIVE_EFFECT_FRAME_READ | ZEND_NATIVE_EFFECT_FRAME_WRITE
			...
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW
			| ZEND_NATIVE_RUNTIME_EFFECT_BAILOUT,
		(const void *) zend_native_frame_observer_end},
	{ZEND_NATIVE_HELPER_FRAME_FINALIZE,
		ZEND_NATIVE_EFFECT_FRAME_READ | ZEND_NATIVE_EFFECT_FRAME_WRITE
			...
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW
			| ZEND_NATIVE_RUNTIME_EFFECT_BAILOUT,
		(const void *) zend_native_frame_finalize},
	{ZEND_NATIVE_HELPER_FRAME_ACTIVATION_RESERVE,
		ZEND_NATIVE_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_ALLOCATE
			| ZEND_NATIVE_RUNTIME_EFFECT_BAILOUT,
		(const void *) zend_native_frame_activation_reserve},
	{ZEND_NATIVE_HELPER_CHECK_FUNC_ARG_RESOLVED,
		ZEND_NATIVE_RUNTIME_EFFECT_FRAME_READ,
		(const void *) zend_native_call_check_func_arg_resolved},
	{ZEND_NATIVE_HELPER_FRAME_ACTIVATION_POP,
		ZEND_NATIVE_EFFECT_FRAME_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_HEAP_WRITE,
		(const void *) zend_native_frame_activation_pop},
	{ZEND_NATIVE_HELPER_FRAME_ACTIVATION_RELEASE,
		ZEND_NATIVE_EFFECT_CALL,
		(const void *) zend_native_frame_activation_release},
	{ZEND_NATIVE_HELPER_CONST_INCLUDE_ONCE,
		ZEND_NATIVE_EFFECT_SYMBOL_SLOW_WRITE
			| ZEND_NATIVE_RUNTIME_EFFECT_OBJECT_WRITE,
		(const void *) zend_native_execute_const_include_once},
	{ZEND_NATIVE_HELPER_DIRECT_INTERNAL_CALL_SET_SOURCE_ARGUMENT,
		ZEND_NATIVE_EFFECT_FRAME_WRITE | ZEND_NATIVE_RUNTIME_EFFECT_ALLOCATE
			| ZEND_NATIVE_RUNTIME_EFFECT_DESTRUCT
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW
			| ZEND_NATIVE_EFFECT_MAY_FAIL,
		(const void *) zend_native_direct_internal_call_set_source_argument},
	{ZEND_NATIVE_HELPER_USER_CALL_SEND_RESOLVED_ARGUMENT,
		ZEND_NATIVE_EFFECT_FRAME_READ | ZEND_NATIVE_EFFECT_FRAME_WRITE
			...
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW
			| ZEND_NATIVE_RUNTIME_EFFECT_BAILOUT,
		(const void *) zend_native_call_send_resolved_argument},
	{ZEND_NATIVE_HELPER_DIRECT_INTERNAL_CALL_SET_INTEGER_ARGUMENT,
		ZEND_NATIVE_EFFECT_FRAME_WRITE | ZEND_NATIVE_RUNTIME_EFFECT_ALLOCATE
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW
			| ZEND_NATIVE_EFFECT_MAY_FAIL,
		(const void *) zend_native_direct_internal_call_set_integer_argument},
	{ZEND_NATIVE_HELPER_DIRECT_INTERNAL_CALL_SET_DOUBLE_ARGUMENT,
		ZEND_NATIVE_EFFECT_FRAME_WRITE | ZEND_NATIVE_RUNTIME_EFFECT_ALLOCATE
			| ZEND_NATIVE_RUNTIME_EFFECT_THROW
			| ZEND_NATIVE_EFFECT_MAY_FAIL,
		(const void *) zend_native_direct_internal_call_set_double_argument},
