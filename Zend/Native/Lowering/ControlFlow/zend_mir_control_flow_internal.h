...
enum {
	...
	ZEND_MIR_W08_OPCODE_FAST_CALL = 162,
	ZEND_MIR_W08_OPCODE_FAST_RET = 163,
	ZEND_MIR_W09_OPCODE_JMP_SET = 152,
	ZEND_MIR_W09_OPCODE_COALESCE = 169,
	ZEND_MIR_W09_OPCODE_FE_RESET_R = 77,
	ZEND_MIR_W09_OPCODE_FE_FETCH_R = 78,
	ZEND_MIR_W09_OPCODE_FE_RESET_RW = 125,
	ZEND_MIR_W09_OPCODE_FE_FETCH_RW = 126,
	ZEND_MIR_W10_OPCODE_JMP_NULL = 198,
	ZEND_MIR_W10_OPCODE_THROW = 108,
	ZEND_MIR_W12_OPCODE_ASSERT_CHECK = 151,
	ZEND_MIR_W12_OPCODE_SWITCH_LONG = 187,
	ZEND_MIR_W12_OPCODE_SWITCH_STRING = 188,
	ZEND_MIR_W12_OPCODE_MATCH = 195,
	ZEND_MIR_W12_OPCODE_BIND_INIT_STATIC_OR_JMP = 203,
	ZEND_MIR_W12_OPCODE_JMP_FRAMELESS = 208
};
