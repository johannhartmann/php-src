--TEST--
Native property reads feed typed component call arguments without a frame
--SKIPIF--
<?php
...
$source = <<<'PHP'
<?php
function w14_property_argument_leaf(string $text, array $values): array
{
    return $values;
}

function w14_property_argument_root(object $box): array
{
    return w14_property_argument_leaf($box->text, $box->values);
}
PHP;

$box = (object) [
    'text' => str_repeat('tpde', 1),
    'values' => [7, 11],
];
$result = native_mir_test_compile_execute(
    $source,
    'w14-property-typed-call-arguments.php',
    [$box],
    [
        'wave' => 11,
        'function' => 'w14_property_argument_root',
        'repeat' => 20,
    ],
);
