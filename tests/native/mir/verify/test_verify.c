...
static void test_entry_failures(void)
{
	...
	zend_mir_verify_fixture_linear(&host);
	host.instructions[0].opcode = (zend_mir_opcode) ZEND_MIR_W12_OPCODE_COUNT;
	host.instructions[1].opcode = (zend_mir_opcode) ZEND_MIR_W12_OPCODE_COUNT;
	host.instructions[2].opcode = (zend_mir_opcode) ZEND_MIR_W12_OPCODE_COUNT;
