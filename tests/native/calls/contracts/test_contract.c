...
int main(void)
{
	...
	assert(ZEND_MIR_OPCODE_CATCH_ENTER == 49);
	assert(ZEND_MIR_OPCODE_COUNT == 41);
	assert(ZEND_MIR_W05_OPCODE_COUNT == 42);
	assert(ZEND_MIR_OPCODE_FINALLY_ENTER == 50);
	assert(ZEND_MIR_OPCODE_FINALLY_CALL == 51);
	assert(ZEND_MIR_OPCODE_FINALLY_RETURN == 52);
	assert(ZEND_MIR_OPCODE_RETURN_SOURCE_ZVAL == 53);
	assert(ZEND_MIR_W08_OPCODE_COUNT == 54);
